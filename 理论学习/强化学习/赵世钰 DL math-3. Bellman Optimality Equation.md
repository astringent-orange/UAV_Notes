...
![[5b3801c8-1335-49c9-9904-ac5d91b9b96f.png]]同样有两个未知数；先求右边的最大值，将x视为常数，易有当y=0时有最大值；此时将y=0带入，去掉max，再求解x=2x-1即可
...
于是有这样一个特殊的贝尔曼公式，即贝尔曼最优公式；对应pai* 的样子如下，只会选择最好的动作
